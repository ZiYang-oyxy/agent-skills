...
written to file immediately using native Codex file editing tools.
...
CODEX PRACTICAL LIMIT: keep each section generation comfortably under the model output ceiling
