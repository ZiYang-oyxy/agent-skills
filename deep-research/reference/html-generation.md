...
Use Python script:
```bash
cd ~/.agents/skills/deep-research
...
**Option B: delegated PDF pass**

Use `spawn_agent` or `assign_task` with one bounded worker dedicated to HTML/PDF conversion, and give it explicit ownership of that step only.
